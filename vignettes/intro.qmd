...
p1 = moment2param(distname = 'st', MoreArgs = list(alpha = 0), kurtosis = krt) |> autoplot() + 
  xlim(-1.5, 1.5) + labs(y = latex2exp::TeX('Student-$t$'))
p2 = moment2param(distname = 'GH', MoreArgs = list(g = 0), kurtosis = krt) |> autoplot() + 
...
p1 = moment2param(dist = 'sn', skewness = skw) |> autoplot(hjust = .42) + 
  xlim(-2, 2.5) + labs(y = 'Skew-Normal')
p2 = moment2param(dist = 'GH', MoreArgs = list(h = 0), skewness = skw) |> autoplot(hjust = .42) + 
...
p1 = moment2param(distname = 'st', skewness = skw, kurtosis = krt) |> autoplot(hjust = .35) +
  xlim(-2, 2.5) + labs(y = latex2exp::TeX('Skew-$t$'))
p2 = moment2param(distname = 'GH', skewness = skw, kurtosis = krt) |> autoplot(hjust = .35) +
...
moment2param(distname = 'gamma', skewness = skw, kurtosis = 3) |> autoplot(hjust = .4) +
