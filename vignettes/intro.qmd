...
-   $\mu = 0$, $\sigma = 1$,
    [Kurtosis]{style="font-weight:bold;background-color:yellow;"}=[.5]{style="color:red;font-weight:bold;"},
    [1]{style="color:green;font-weight:bold;"}, or
    [1.5]{style="color:blue;font-weight:bold;"}
...
-   R function `sn::dsn`   [location $\xi$, scale $\omega$, slant
    $\alpha$]{style="background-color:yellow;"}

-   $\mu = 0$, $\sigma = 1$,
    [Skewness]{style="font-weight:bold;background-color:yellow;"}=[.2]{style="color:red;font-weight:bold;"},
    [.5]{style="color:green;font-weight:bold;"}, or
    [.8]{style="color:blue;font-weight:bold;"}
...
-   R function `sn::dst`   [location $\xi$, scale $\omega$, slant
    $\alpha$, degree-of-freedom $\nu$]{style="background-color:yellow;"}

-   $\mu = 0$, $\sigma = 1$, [(Skewness,
    Kurtosis)]{style="font-weight:bold;background-color:yellow;"}=[(.2,.5)]{style="color:red;font-weight:bold;"},
    [(.5,1)]{style="color:green;font-weight:bold;"}, or
    [(.8,1.5)]{style="color:blue;font-weight:bold;"}
